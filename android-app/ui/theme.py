"""
ui/theme.py — Theme definitions & color palettes for Aurora Android App
"""
...
THEMES = {
    "aurora": {
        ...
        "badge_ai_bg":     (0.15, 0.35, 0.45, 1),
        "badge_ai_fg":     (0.40, 0.95, 0.88, 1),
        "badge_user_bg":   (0.20, 0.40, 0.60, 1),
        "badge_user_fg":   (0.85, 0.95, 1.0, 1),
    ...
    "light": {
        ...
        "badge_ai_bg":     (0.88, 0.92, 0.98, 1),
        "badge_ai_fg":     (0.15, 0.35, 0.75, 1),
        "badge_user_bg":   (0.80, 0.88, 0.95, 1),
        "badge_user_fg":   (0.10, 0.25, 0.50, 1),
    ...
    "slate": {
        ...
        "badge_ai_bg":     (0.25, 0.32, 0.44, 1),
        "badge_ai_fg":     (0.70, 0.85, 1.0, 1),
        "badge_user_bg":   (0.28, 0.40, 0.58, 1),
        "badge_user_fg":   (0.85, 0.92, 1.0, 1),
